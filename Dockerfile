...
RUN wget https://github.com/cytoscape/cytoscape/releases/download/3.9.0/cytoscape-unix-3.9.0.tar.gz
RUN tar xf cytoscape-unix-3.9.0.tar.gz && rm cytoscape-unix-3.9.0.tar.gz
