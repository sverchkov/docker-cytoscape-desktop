...
RUN wget --progress=dot:giga --local-encoding=UTF-8 -v https://github.com/cytoscape/cytoscape/releases/download/3.8.0/cytoscape-unix-3.8.2.tar.gz -O cytoscape-unix-3.8.2.tar.gz
